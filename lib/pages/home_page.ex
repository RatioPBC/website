      ...
      <div class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center">
          <h1 class="text-4xl md:text-6xl font-bold mb-6">Unlock the power<br />
            <span class="text-cream">of connected data</span></h1>
          <p class="text-xl md:text-2xl mb-8 max-w-3xl mx-auto opacity-90">
            We solve complex data interoperability challenges and build sustainable data strategies that scale across programs and jurisdictions
          </p>
          <div class="flex flex-col sm:flex-row gap-4 justify-center">
            <a
              href={"mailto:" <> Ratio.email()}
              class="bg-ink hover:bg-opacity-90 text-white px-8 py-3 rounded-lg font-semibold transition-all"
            >
              Let's talk
            </a>
          </div>
      ...
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center mb-12">
          <h2 class="text-3xl md:text-4xl font-bold text-ink mb-4">
            Ratio is a proven delivery partner
          </h2>
          <p class="text-xl text-dark-gray max-w-3xl mx-auto">
            Public sector and mission-driven organizations bring Ratio their toughest data integration and system modernization challenges. We're honored to serve leading government agencies throughout the US.
          </p>
        </div>
        <div class="grid md:grid-cols-2 gap-8">
          <div class="bg-cream p-8 rounded-lg">
            <div class="w-16 h-16 bg-sunset rounded-full flex items-center justify-center mx-auto mb-4">
              <svg
                class="w-12 h-12 icon icon-state-NY"
                fill="white"
                viewBox="0 0 24 24"
            ...
            <p class="text-dark-gray mb-4">
              Modernized clinical record retrieval system,
              <b>enabling dynamic queries across the statewide health information exchange</b>
              to enable data analysis supporting public health emergency response efforts.
            </p>
          </div>
          <div class="bg-cream p-8 rounded-lg">
            <div class="w-16 h-16 bg-sunset rounded-full flex items-center justify-center mx-auto mb-4">
              <svg
                class="w-1=9 h-9 icon icon-state-CO"
                fill="white"
                viewBox="0 0 24 24"
                style="transform: translateY(2px)"
              >
            ...
            <p class="text-dark-gray mb-4">
              Developed an interoperability strategy rooted in user research and technology discovery for state behavioral health providers,
              <b>aimed at reducing administrative burden through system integration.</b>
            </p>
          </div>
          <div class="bg-cream p-8 rounded-lg">
            <div class="w-16 h-16 bg-sunset rounded-full flex items-center justify-center mx-auto mb-4">
              <svg
                class="w-12 h-12 icon icon-state-NJ"
                fill="white"
                viewBox="0 0 24 24"
            ...
            <p class="text-dark-gray mb-4">
              Designed and developed automated data collection application and COVID-19 lab result processing pipelines,
              <b>modernizing infectious disease surveillance and reducing manual data entry</b>
          ...
          <div class="bg-cream p-8 rounded-lg">
            <div class="w-16 h-16 bg-sunset rounded-full flex items-center justify-center mx-auto mb-4">
              <svg
                class="w-12 h-12 icon icon-state-CA"
                fill="white"
                viewBox="0 0 24 24"
                style="transform: translateY(4px)"
              >
            ...
            <p class="text-dark-gray mb-4">
              Conducted technical discovery and assessment of the Treasurer and Tax Collector's legacy business tax system,
              <b>developing modernization strategy and migration roadmap</b>
              that guided procurement for a new system.
            </p>
          </div>
        </div>
      </div>
  ...
  def services(assigns) do
    ...
    <section class="py-16 bg-cream">
      <div class="text-center mb-12">
        ...
        <p class="text-xl text-dark-gray max-w-3xl mx-auto">
          From strategic planning to technical implementation, we provide end-to-end data consulting services tailored to the complex needs of public sector organizations.
        </p>
      </div>
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="grid lg:grid-cols-3 gap-8">
          ...
          <div id="#data-and-analytics-engineering" class="bg-white p-8 rounded-lg">
            <div class="w-16 h-16 bg-sunset rounded-full flex items-center justify-center mb-6">
              <svg class="w-8 h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path
                  stroke-linecap="round"
          ...
          <div id="#system-integration" class="bg-white p-8 rounded-lg">
            <div class="w-16 h-16 bg-sunset rounded-full flex items-center justify-center mb-6">
              <svg class="w-8 h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path
                  stroke-linecap="round"
        ...
        <div class="grid md:grid-cols-3 gap-8">
          <div class="text-center">
            ...
            <p class="text-dark-gray">
              <i>We understand your constraints</i>
              <br /><br />Our team brings deep healthcare and public sector experience to modern data challenges, handling HIPAA compliance, regulatory reporting, and complex stakeholder needs.
            </p>
          </div>
          <div class="text-center">
            <div class="w-16 h-16 bg-ink text-white rounded-full flex items-center justify-center mx-auto mb-4 text-xl font-bold">
            ...
            <p class="text-dark-gray">
              <i>We deliver value early and often.</i> <br /><br />
              Nothing beats showing working software to actual users. We cut through ambiguity by delivering and iterating quickly, de-risking the traditional approach to software projects.
            </p>
          </div>
          <div class="text-center">
            <div class="w-16 h-16 bg-ink text-white rounded-full flex items-center justify-center mx-auto mb-4 text-xl font-bold">
            ...
            <p class="text-dark-gray">
              <i>We build trust through transparency</i> <br /><br />
  ...
  def cta(assigns) do
    ...
    <section class="py-16 bg-ink text-white">
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        <h2 class="text-3xl md:text-4xl font-bold mb-4">Ready to unlock your data's potential?</h2>
